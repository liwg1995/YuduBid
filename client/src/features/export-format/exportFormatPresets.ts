...
type BodyTextLayoutStyle = Omit<BodyTextStyleConfig, 'spacing_before_unit' | 'spacing_after_unit' | 'line_spacing_mode' | 'line_spacing_unit'>;
...
function heading(
  ...
  return {
    ...
    line_spacing_mode: lineSpacing === 1 ? 'single' : 'multiple',
