...
export interface YuDuBidBridge {
  ...
  bidOpportunity: {
    getSnapshot: (filters?: { keyword?: string; monitorId?: string; status?: string; inbox?: string }) => Promise<OpportunitySnapshot>;
    get: (opportunityId: string) => Promise<BidOpportunity>;
    showReminder: () => Promise<{ shown: boolean; message: string; overdue: number; today: number; urgentDeadlines: number }>;
    createWorkspaceBackup: () => Promise<{ success: boolean; latestId: string; createdAt: string; verified: boolean; message: string; path: string }>;
    verifyLatestBackup: () => Promise<{ success: boolean; latestId: string; createdAt: string; verified: boolean; verifiedAt?: string; message: string; path: string }>;
    save: (payload: OpportunityDraft) => Promise<BidOpportunity>;
    importFile: () => Promise<{ success: boolean; message?: string; opportunity?: BidOpportunity }>;
    importTenderFile: (opportunityId: string) => Promise<{ success: boolean; message?: string; opportunity: BidOpportunity }>;
    updateStatus: (payload: { opportunityId: string; status: OpportunityStatus; notes?: string }) => Promise<BidOpportunity>;
    bulkUpdate: (payload: { opportunityIds: string[]; status?: OpportunityStatus; owner?: string }) => Promise<{ success: boolean; updatedCount: number }>;
    updateDecisionWorkflow: (payload: { opportunityId: string; workflowStage: OpportunityWorkflowStage; decisionOutcome: OpportunityDecisionOutcome; decisionReason?: string; decisionDueAt?: string; nextAction?: string; nextActionDueAt?: string }) => Promise<BidOpportunity>;
    saveMonitor: (payload: OpportunityMonitorDraft) => Promise<{ monitor: OpportunityMonitor; monitors: OpportunityMonitor[] }>;
    deleteMonitor: (monitorId: string) => Promise<{ success: boolean; monitors: OpportunityMonitor[] }>;
    createPresalesProject: (opportunityId: string) => Promise<{ opportunity: BidOpportunity; projectId: string; existing?: boolean }>;
    sendTenderToTechnicalPlan: (opportunityId: string) => Promise<{ success: boolean; message: string; projectId: string; opportunity: BidOpportunity }>;
    sendTenderToRejectionCheck: (opportunityId: string) => Promise<{ success: boolean; message: string; opportunity: BidOpportunity }>;
    getEnterpriseProfile: () => Promise<OpportunityEnterpriseProfile>;
    saveEnterpriseProfile: (payload: OpportunityEnterpriseProfile) => Promise<OpportunityEnterpriseProfile>;
    startDeepAnalysis: (opportunityId: string) => Promise<BidOpportunity>;
    startSourceScan: (sourceId: string) => Promise<OpportunityScanRun>;
    startAllSourceScans: () => Promise<OpportunityScanBatch>;
    mergeProjectClusters: (payload: { opportunityId: string; targetClusterId: string }) => Promise<BidOpportunity>;
    splitProjectCluster: (opportunityId: string) => Promise<BidOpportunity>;
    updateSource: (payload: { sourceId: string; enabled?: boolean; maxItems?: number }) => Promise<OpportunitySource>;
    onEvent: (callback: (event: { opportunity?: BidOpportunity; scan?: OpportunityScanRun; source?: OpportunitySource; scanBatch?: OpportunityScanBatch }) => void) => () => void;
  };
  thesisTutor: {
  ...
  feasibilityReport: {
    listProjects: () => Promise<FeasibilityProjectList>;
    createProject: (payload: { projectName?: string; name?: string }) => Promise<{ project: FeasibilityProjectRecord; projects: FeasibilityProjectList }>;
    renameProject: (payload: FeasibilityProjectPayload & { name: string; projectName?: string }) => Promise<FeasibilityProjectList>;
    deleteProject: (payload: FeasibilityProjectPayload) => Promise<FeasibilityProjectList>;
    switchProject: (payload: FeasibilityProjectPayload) => Promise<FeasibilityReportState>;
    loadState: (payload: FeasibilityProjectPayload) => Promise<FeasibilityReportState>;
    updateStep: (payload: FeasibilityProjectPayload & { step: FeasibilityReportStep }) => Promise<FeasibilityReportState>;
    saveProjectInfo: (payload: FeasibilityProjectPayload & { projectInfo: FeasibilityProjectInfo; clearDownstream?: boolean }) => Promise<FeasibilityReportState>;
    importSources: (payload: FeasibilityProjectPayload) => Promise<{ success: boolean; message?: string; importedSourceIds?: string[]; state: FeasibilityReportState }>;
    readSourceMarkdown: (payload: FeasibilityProjectPayload & { sourceId: string }) => Promise<string>;
    removeSource: (payload: FeasibilityProjectPayload & { sourceId: string }) => Promise<FeasibilityReportState>;
    saveAnalysis: (payload: FeasibilityProjectPayload & { markdown: string }) => Promise<FeasibilityReportState>;
    saveOutlineConfig: (payload: FeasibilityProjectPayload & { outlineTemplate: FeasibilityOutlineTemplate; targetWords: number; referenceDocumentIds: string[] }) => Promise<FeasibilityReportState>;
    saveOutline: (payload: FeasibilityProjectPayload & { outlineData: OutlineData }) => Promise<FeasibilityReportState>;
    saveKeyParameters: (payload: FeasibilityProjectPayload & { markdown: string }) => Promise<FeasibilityReportState>;
    saveChapterContent: (payload: FeasibilityProjectPayload & { nodeId: string; content: string }) => Promise<FeasibilityReportState>;
    saveContentGenerationOptions: (payload: FeasibilityProjectPayload & { contentGenerationOptions: FeasibilityContentGenerationOptions }) => Promise<FeasibilityReportState>;
    startAnalysis: (payload: FeasibilityProjectPayload) => Promise<FeasibilityBackgroundTaskState>;
    startOutline: (payload: FeasibilityProjectPayload & { outlineTemplate: FeasibilityOutlineTemplate; targetWords: number; referenceDocumentIds: string[] }) => Promise<FeasibilityBackgroundTaskState>;
    startOutlineAdjustment: (payload: FeasibilityProjectPayload & { instruction: string }) => Promise<FeasibilityBackgroundTaskState>;
    startParameters: (payload: FeasibilityProjectPayload) => Promise<FeasibilityBackgroundTaskState>;
    startContent: (payload: FeasibilityProjectPayload & { sectionIds?: string[]; regenerateAll?: boolean; contentGenerationOptions?: FeasibilityContentGenerationOptions }) => Promise<FeasibilityBackgroundTaskState>;
    pauseContent: (payload: FeasibilityProjectPayload) => Promise<FeasibilityBackgroundTaskState>;
    startHumanWriting: (payload: FeasibilityProjectPayload & { sectionIds?: string[] }) => Promise<FeasibilityBackgroundTaskState>;
    getActiveTasks: (payload: FeasibilityProjectPayload) => Promise<{ tasks: FeasibilityBackgroundTaskState[]; state: FeasibilityReportState }>;
    onTaskEvent: (callback: (event: FeasibilityTaskEvent) => void) => () => void;
    clear: (payload: FeasibilityProjectPayload) => Promise<{ success: boolean; message?: string; state: FeasibilityReportState }>;
  };
  duplicateCheck: {
