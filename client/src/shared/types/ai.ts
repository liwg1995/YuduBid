...
export interface ChatTextContentPart { type: 'text'; text: string }
export interface ChatImageUrlContentPart { type: 'image_url'; image_url: { url: string; detail?: ChatImageDetail } }
export interface ChatLocalImageContentPart { type: 'local_image'; path: string; detail?: ChatImageDetail }
