...
const pageLabels = {
  ...
  'thesis-diagnosis': '论文导师 - 启动诊断',
  'thesis-topic': '论文导师 - 选题与开题',
  'thesis-literature': '论文导师 - 文献综述',
  'thesis-methodology': '论文导师 - 研究设计',
  'thesis-writing': '论文导师 - 逐章写作',
  'thesis-review': '论文导师 - 评审与答辩',
  'thesis-format': '论文导师 - 格式与查重',
